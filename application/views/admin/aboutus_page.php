                ...
                <form role="form" method="post" action="<?=base_url('admin/uploadeditaboutdetails')?>" enctype="multipart/form-data">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="Information" name="Information" placeholder="Enter Information" rows="4"><?=$aboutus[0]->information?></textarea>
                    </div>
                ...
                <form role="form" method="post" action="<?=base_url('admin/uploadaboutus')?>" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="Information" name="Information" placeholder="Enter Information" rows="4"></textarea>
                    </div>
                  </div>
                  <!-- /.box-body -->
