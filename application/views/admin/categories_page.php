        ...
        <div class="col-md-5">
          ...
          <div class="box box-primary">
            ...
            <?php if(isset($categorydata) && count($categorydata) != 0){ ?>
              <form role="form" method="post" action="<?=base_url('admin/dashboard/categories/saveEditdetails')?>" enctype="multipart/form-data">
              <div class="box-body">
                <input type="hidden" name="edit_id" value="<?=$categorydata[0]->id?>">
                <div class="form-group">
                  <label for="category_name">Category Name</label>
                  <input type="text" class="form-control" name="category_name" id="category_name" value="<?=$categorydata[0]->name?>" placeholder="Enter Category Name">
                </div>
                <div class="form-group">
            ...
            <?php }else{ ?>
              <form role="form" method="post" action="<?=base_url('admin/dashboard/categories/save')?>" enctype="multipart/form-data">
                <div class="box-body">
                  <div class="form-group">
                    <label for="category_name">Category Name</label>
                  ...
                  <tbody>
                    <?php $i = 1; foreach ($categories as $key => $category) { ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?=base_url('admin/dashboard/categories/'.$category->id.'/edit')?>" onclick="return confirm('Are you want to edit category..?')"><i class="fa fa-edit fa-lg"></i></a>&nbsp;
                          <a href="<?=base_url('admin/dashboard/categories/'.$category->id.'/delete')?>" onclick="return confirm('Are you want to delete category..?')"><i class="fa fa-trash-o fa-lg"></i></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
