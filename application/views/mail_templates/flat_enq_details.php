        ...
        <td align="center" valign="top"  bgcolor="#ffffff">
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <tr>
              ...
              <td align="center"><a href="#" target="_blank" style="text-decoration:none;"><img src="<?=base_url()?>images/sbg_logo.png" width="230" height="80" style="display:block;font-family: Arial, sans-serif; font-size:15px; line-height:18px; color:#30373b;  font-weight:bold;" border="0" alt="LoGo Here" /></a></td>
              ...
              <td valign="top" class="em_aside">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td height="1" bgcolor="#d8e4f0" style="font-size:0px;line-height:0px;"><img src="https://www.sendwithus.com/assets/img/emailmonks/images/spacer.gif" width="1" height="1" alt="" style="display:block;" border="0" />

                      <?php //echo "<pre>"; print_r($viewdetails); echo "</pre>"; ?>
                  ...
                  <tr>
                    ...
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;"><?=$viewdetails['layout_name']?>.' Layout of <?=$viewdetails['flat_id']?> Flat Enquery by <?=$viewdetails['name']?>,
                  ...
                  <!-- <tr>
                    ...
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; line-height:20px; color:#feae39;">You Register Id :</td>
                  ...
                  <tr>
                    ...
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#999999;">
						...
						<ul>
							<li><label>layout Name : </label> <?=$viewdetails['layout_name']?></li>
							<li><label>Name : </label> <?=$viewdetails['name']?></li>
							<li><label>Mobile : </label> <?=$viewdetails['mobile']?></li>
							<li><label>Mail id : </label> <?=$viewdetails['mail_id']?></li>
							<li><label>Details : </label><p><?=$viewdetails['details']?></p></li>
						</ul>

                        Dear Mr/Ms:  Welcome to "Sri Balaji Group" Family Member. Your Bussiness ID NO:  <?=$viewdetails['reg_id']?> Thank you. our Best Support in Transforming Your Dreams into Reality. Good Luck and God Bless You.
          ...
          <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="em_main_table" style="table-layout:fixed;">
            ...
            <tr>
              ...
              <td align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:12px; line-height:18px; color:#848789;text-transform:uppercase;">
                ...
                &copy;2&zwnj;019 sri balaji groups. All Rights Reserved.
