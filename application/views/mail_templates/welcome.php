...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>welcome to sbgindia family..!</title>
            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; font-weight:bold; line-height:18px; color:#30373b;">Welcome <?=$viewdetails['name']?>,
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#999999;">
                        ...
                        Dear Mr/Ms: <?=$viewdetails['name']?> Welcome to "Sri Balaji Group" Family Member. Your Bussiness ID NO:  <?=$viewdetails['reg_id']?> Thank you. our Best Support in Transforming Your Dreams into Reality. Good Luck and God Bless You.
